                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    @component('components.selects.accounts', ['selectedAccountId' => old('supplier_account_id'), 'cashAccountFlag' => true, 'selectName' => 'supplier_account_id', 'tabindex' => 3])
                                                    @endcomponent
                                                    {{-- adding error_message p tag component --}}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control decimal_number_only" name="purchase_quantity" id="purchase_quantity" placeholder="Quantity" value="{{ old('purchase_measure_type') == 3 ? 1 : old('purchase_quantity') }}" {{ old('purchase_measure_type') == 3 ? "readonly" : "" }} tabindex="5">
                                                    {{-- adding error_message p tag component --}}
